...
public class Tutorial3 extends Scene {
	...
	// konstruktor
	public Tutorial3(SceneManager gsm) {
		this.gsm = gsm;
	}
	...
	public void draw(Graphics2D g) {
		try {
			if(Tutorial0.isPolish){
				bg = new Background("Resources/Backgrounds/Tutorial/taven2.png");
			}
			else{
				bg = new Background("Resources/Backgrounds/Tutorial/taven.png");
			}
