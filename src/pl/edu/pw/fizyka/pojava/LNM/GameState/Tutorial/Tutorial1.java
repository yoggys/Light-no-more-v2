...
public class Tutorial1 extends Scene {
	...
	// konstruktor
	public Tutorial1(SceneManager gsm) {
		this.gsm = gsm;
	}
	...
	public void draw(Graphics2D g) {
		try {
			if(Tutorial0.isPolish){
				bg = new Background("Resources/Backgrounds/Tutorial/charl2.png");
			}
			else{
				bg = new Background("Resources/Backgrounds/Tutorial/charl.png");
			}
