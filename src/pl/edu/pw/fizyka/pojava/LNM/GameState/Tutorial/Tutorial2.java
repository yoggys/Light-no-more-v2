...
public class Tutorial2 extends Scene {
	...
	// konstruktor
	public Tutorial2(SceneManager gsm) {
		this.gsm = gsm;
	}
	...
	public void draw(Graphics2D g) {
		try {
			if(Tutorial0.isPolish){
				bg = new Background("Resources/Backgrounds/Tutorial/merch2.png");
			}
			else{
				bg = new Background("Resources/Backgrounds/Tutorial/merch.png");
			}
