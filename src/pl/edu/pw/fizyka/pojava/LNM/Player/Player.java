...
public class Player {
	...
	public static void championCurCard(int choice, Graphics2D g, Images image, int x, int y) {
		...
		g.drawString(
				"HP/MAX_HP: " + Player.champions.get(choice).getHp() + "/" + Player.champions.get(choice).getMaxHp(),
				x + 50, y + 30 * 7);
		g.drawString("SA/MAX_SA: " + Player.champions.get(choice).getStamina() + "/"
				+ Player.champions.get(choice).getMaxStamina(), x + 50, y + 30 * 8);
		g.drawString(langCards[1] + "(" + langCards[2] + "/" + langCards[3] + "): ", x + 50, y + 30 * 9);
		if (Player.champions.get(choice).skills.size() != 0) {
			if (Player.champions.get(choice).skills.get(0).getEffect() == null) {
				g.drawString(
						"*" + Player.champions.get(choice).skills.get(0).getName() + "("
				...
				g.drawString(
						"*" + Player.champions.get(choice).skills.get(0).getName() + "("
								+ -1 * ((Player.champions.get(choice).skills.get(0).getDamage()
										+ Player.champions.get(choice).skills.get(0).getEffect().getTotal()))
								+ ")",
						x + 50, y + 30 * 10);
			}
			if (Player.champions.get(choice).skills.get(0).getEffect() == null) {
				g.drawString(
						"*" + Player.champions.get(choice).skills.get(1).getName() + "("
				...
				g.drawString(
						"*" + Player.champions.get(choice).skills.get(1).getName() + "("
								+ -1 * ((Player.champions.get(choice).skills.get(1).getDamage()
										+ Player.champions.get(choice).skills.get(1).getEffect().getTotal()))
								+ ")",
						x + 50, y + 30 * 11);
			}
		} else {
	...
	public static void championResCard(int choice, Graphics2D g, Images image, int x, int y) {
		...
		g.drawString("HP/MAX_HP: " + Player.reserve.get(choice).getHp() + "/" + Player.reserve.get(choice).getMaxHp(),
				x + 50, y + 30 * 7);
		g.drawString("SA/MAX_SA: " + Player.reserve.get(choice).getStamina() + "/"
				+ Player.reserve.get(choice).getMaxStamina(), x + 50, y + 30 * 8);
		g.drawString(langCards[1] + "(" + langCards[2] + "/" + langCards[3] + "): ", x + 50, y + 30 * 9);
		if (Player.reserve.get(choice).skills.size() != 0) {
			if (Player.reserve.get(choice).skills.get(0).getEffect() == null) {
				g.drawString(
						"*" + Player.reserve.get(choice).skills.get(0).getName() + "("
				...
				g.drawString(
						"*" + Player.reserve.get(choice).skills.get(0).getName() + "("
								+ -1 * ((Player.reserve.get(choice).skills.get(0).getDamage()
										+ Player.reserve.get(choice).skills.get(0).getEffect().getTotal()))
								+ ")",
						x + 50, y + 30 * 10);
			}
			if (Player.reserve.get(choice).skills.get(0).getEffect() == null) {
				g.drawString(
						"*" + Player.reserve.get(choice).skills.get(1).getName() + "("
				...
				g.drawString(
						"*" + Player.reserve.get(choice).skills.get(1).getName() + "("
								+ -1 * ((Player.reserve.get(choice).skills.get(1).getDamage()
										+ Player.reserve.get(choice).skills.get(1).getEffect().getTotal()))
								+ ")",
						x + 50, y + 30 * 11);
			}
		} else {
	...
	public static void championTavCard(int choice, Graphics2D g, Images image, int x, int y) {
		...
		g.drawString("HP/MAX_HP: " + Player.tavernChampions.get(choice).getHp() + "/"
				+ Player.tavernChampions.get(choice).getMaxHp(), x + 50, y + 30 * 7);
		g.drawString("SA/MAX_SA: " + Player.tavernChampions.get(choice).getStamina() + "/"
				+ Player.tavernChampions.get(choice).getMaxStamina(), x + 50, y + 30 * 8);
		g.drawString(langCards[1] + "(" + langCards[2] + "/" + langCards[3] + "): ", x + 50, y + 30 * 9);
		if (Player.tavernChampions.get(choice).skills.size() != 0) {
			if (Player.tavernChampions.get(choice).skills.get(0).getEffect() == null) {
				g.drawString(
						"*" + Player.tavernChampions.get(choice).skills.get(0).getName() + "("
				...
				g.drawString("*" + Player.tavernChampions.get(choice).skills.get(0).getName() + "("
						+ -1 * ((Player.tavernChampions.get(choice).skills.get(0).getDamage()
								+ Player.tavernChampions.get(choice).skills.get(0).getEffect().getTotal()))
						+ ")", x + 50, y + 30 * 10);
			}
			if (Player.tavernChampions.get(choice).skills.get(0).getEffect() == null) {
				g.drawString(
						"*" + Player.tavernChampions.get(choice).skills.get(1).getName() + "("
				...
				g.drawString("*" + Player.tavernChampions.get(choice).skills.get(1).getName() + "("
						+ -1 * ((Player.tavernChampions.get(choice).skills.get(1).getDamage()
								+ Player.tavernChampions.get(choice).skills.get(1).getEffect().getTotal()))
						+ ")", x + 50, y + 30 * 11);
			}
		} else {
			g.drawString(langCards[4], x + 50, y + 30 * 10);
