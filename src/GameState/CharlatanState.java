...
public class CharlatanState extends GameState {
	...
	public CharlatanState(GameStateManager gsm) {	
		...
		//test
		try {
			bg = new Background("/Backgrounds/charbg.png");
	...
	public void draw(Graphics2D g) {
		...
		for(int i = 0; i < 3; i++) {
			...
			if(Player.champions.get(i).getPercent() >= 90){
				image.draw(g, 298 + 200*i, 380, "/HUD/highframe2.png");
				image.draw(g, 298 + 200*i, 380, "/HUD/champ"+i+".png");
				...
				image.draw(g, 298 + 200*i, 380, "/HUD/midframe2.png");
				image.draw(g, 298 + 200*i, 380, "/HUD/champ"+i+".png");	
				g.drawString(String.valueOf((int)Player.champions.get(i).payHeal()), 427 + (200*i) + (int)(check[i]*12), 615);
			}
			else{
				image.draw(g, 298 + 200*i, 380, "/HUD/lowframe2.png");
				image.draw(g, 298 + 200*i, 380, "/HUD/champ"+i+".png");	
				g.drawString(String.valueOf((int)Player.champions.get(i).payHeal()), 427 + (200*i) + (int)(check[i]*12), 615);
			}
		}
